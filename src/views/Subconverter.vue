  ...
  data() {
    return {
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://subapi.cr7.us.ci" : this.getUrlParam(),
        shortType: "https://v1.mk/short",
        remoteConfig: "https://dyzhqd2.cr7.us.ci/subconverter?selectedRules=comprehensive",
        excludeRemarks: "",
        includeRemarks: "",
        filename: "",
        rename: "",
